public class Sim4 {
    ...
    public class InstructionFields {int opcode; int rs;
                                        int rt;        int rd;
                                        int shamt;     int funct;
                                        int imm16, imm32;   int address;
    }

    public class CPUControl {ALUControl ALU = new ALUControl();
                                    int ALUsrc;     int memRead;
                                    int memWrite;   int memToReg;
                                    int regDst;     int regWrite;
                                    int branch;     int jump;
                                    int extra1, extra2, extra3;
                                    public class ALUControl {int op; int bNegate;}
    }

    public class ALUResult {int result; int zero; int extra;}

    public class MemResult {int readVal;}
